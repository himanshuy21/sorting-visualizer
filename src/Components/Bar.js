// in this we will give an array to this bar.js and this will give us the bar
// for each one of the array
import { useState, useEffect } from "react";
import "./Bar.css";
export default function Bar({ index, length, color, changeArray }) {
  ...
  const bottom = {
    transfrom: `translateY(${200 - length}px) rotateX(-90deg)`,
